...
const FTMS_CONTROL_POINT_CHARACTERISTIC_UUID = 0x2ad9;
const INDOOR_BIKE_DATA_CHARACTERISTIC_UUID = 0x2ad2;
const HR_SERVICE_UUID = 0x180d;
const HR_MEASUREMENT_CHARACTERISTIC_UUID = 0x2a37;
const POWER_ZONES = {
    Z1: {
        ...
        color: 'hsl(210, 50%, 70%)',
        description: 'Very light activity, for recovery.'
    },
    Z2: {
        name: 'Z2 Endurance',
        percentage: [
        ...
        color: 'hsl(120, 50%, 60%)',
        description: 'Classic long-distance pace.'
    },
    Z3: {
        name: 'Z3 Tempo',
        percentage: [
        ...
        color: 'hsl(60, 80%, 60%)',
        description: 'Spirited "brisk" riding.'
    },
    Z4: {
        name: 'Z4 Threshold',
        percentage: [
        ...
        color: 'hsl(30, 90%, 60%)',
        description: 'Sustained, hard effort.'
    },
    Z5: {
        name: 'Z5 VO2 Max',
        percentage: [
        ...
        color: 'hsl(0, 85%, 65%)',
        description: 'Hard intervals to increase max power.'
    },
    Z6: {
        name: 'Z6 Anaerobic',
        percentage: [
        ...
        color: 'hsl(300, 80%, 70%)',
        description: 'Short, max-intensity sprints.'
    }
};
...
"[project]/src/store/device-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        actions: {
            connectTrainer: async ()=>{
                ...
                try {
                    ...
                    // Get Control Point
                    ftmsControlPoint = await service.getCharacteristic(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FTMS_CONTROL_POINT_CHARACTERISTIC_UUID"]);
                    // Subscribe to Indoor Bike Data
                    const indoorBikeData = await service.getCharacteristic(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDOOR_BIKE_DATA_CHARACTERISTIC_UUID"]);
                    ...
                    set({
                        trainerConnected: true,
                        trainerName: trainerDevice.name || 'Smart Trainer'
                    });
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                        title: 'Trainer Connected',
                        description: "".concat(trainerDevice.name || 'Smart Trainer', " is ready.")
                    });
                } catch (error) {
            ...
            disconnectTrainer: ()=>{
                var _trainerDevice_gatt;
                if (trainerDevice === null || trainerDevice === void 0 ? void 0 : (_trainerDevice_gatt = trainerDevice.gatt) === null || _trainerDevice_gatt === void 0 ? void 0 : _trainerDevice_gatt.connected) {
                    ...
                    if (!mockInterval) {
                        mockInterval = setInterval(()=>{
                            set((state)=>({
                                    metrics: {
                                        ...state.metrics,
                                        heartRate: Math.round(120 + Math.sin(Date.now() / 5000) * 20)
                                    }
                                }));
                        }, 1000);
                    }
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                        title: 'Mock HR Connected'
                    });
                    return;
                }
                try {
                    ...
                    const characteristic = await service.getCharacteristic(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HR_MEASUREMENT_CHARACTERISTIC_UUID"]);
                    ...
                    set({
                        hrConnected: true,
                        hrName: hrDevice.name || 'Heart Rate Monitor'
                    });
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
                        title: 'HR Monitor Connected',
                        description: "".concat(hrDevice.name || 'HR Monitor', " is ready.")
                    });
                } catch (error) {
            ...
            disconnectHR: ()=>{
                var _hrDevice_gatt;
                if (hrDevice === null || hrDevice === void 0 ? void 0 : (_hrDevice_gatt = hrDevice.gatt) === null || _hrDevice_gatt === void 0 ? void 0 : _hrDevice_gatt.connected) {
...
const useDevice = ()=>{
    ...
    return useDeviceStore({
        "useDevice.useDeviceStore": (state)=>state
    }["useDevice.useDeviceStore"]);
};
_s(useDevice, "xfCGhHWElzuIPf23MiUYZgIPt/U=", false, function() {
    return [
        useDeviceStore
    ];
});
const useDeviceActions = ()=>{
    _s1();
    return useDeviceStore({
        "useDeviceActions.useDeviceStore": (state)=>state.actions
    }["useDeviceActions.useDeviceStore"]);
};
_s1(useDeviceActions, "xfCGhHWElzuIPf23MiUYZgIPt/U=", false, function() {
    return [
        useDeviceStore
    ];
});
const useMetrics = ()=>{
    _s2();
    return useDeviceStore({
        "useMetrics.useDeviceStore": (state)=>state.metrics
    }["useMetrics.useDeviceStore"]);
};
_s2(useMetrics, "xfCGhHWElzuIPf23MiUYZgIPt/U=", false, function() {
    return [
        useDeviceStore
    ];
});
const useDeviceConnection = ()=>{
    _s3();
    return useDeviceStore({
        "useDeviceConnection.useDeviceStore": (state)=>({
    ...
    }["useDeviceConnection.useDeviceStore"]);
};
_s3(useDeviceConnection, "xfCGhHWElzuIPf23MiUYZgIPt/U=", false, function() {
    return [
        useDeviceStore
    ];
});
...
"[project]/src/components/device/connection-status.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ConnectionStatus() {
    _s();
    const { trainerConnected, hrConnected, trainerName, hrName, isMock } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$device$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeviceConnection"])();
    const { connectTrainer, disconnectTrainer, connectHR, disconnectHR } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$device$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeviceActions"])();
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$bluetooth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Bluetooth$3e$__["Bluetooth"], {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('w-4 h-4 mr-2', trainerConnected ? 'text-accent' : 'text-muted-foreground')
                        }, void 0, false, {
                            fileName: "[project]/src/components/device/connection-status.tsx",
                            lineNumber: 32,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$heart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Heart$3e$__["Heart"], {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('w-4 h-4', hrConnected ? 'text-red-500' : 'text-muted-foreground'),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuContent"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                        ...
                        children: [
                            trainerConnected ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    trainerName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-muted-foreground",
                                        children: trainerName
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/device/connection-status.tsx",
                                        lineNumber: 59,
                                        columnNumber: 29
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-xs",
                                children: trainerConnected ? 'Disconnect' : 'Connect'
                            }, void 0, false, {
                                fileName: "[project]/src/components/device/connection-status.tsx",
                                lineNumber: 61,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                        ...
                        children: [
                            hrConnected ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        children: "Heart Rate Monitor"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/device/connection-status.tsx",
                                        lineNumber: 71,
                                        columnNumber: 13
                                    }, this),
                                    hrName && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-muted-foreground",
                                        children: hrName
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/device/connection-status.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-xs",
                                children: hrConnected ? 'Disconnect' : 'Connect'
                            }, void 0, false, {
                                fileName: "[project]/src/components/device/connection-status.tsx",
                                lineNumber: 74,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "px-2 py-1.5 text-xs text-muted-foreground flex items-center",
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: "Connect devices to start training."
                            }, void 0, false, {
                                fileName: "[project]/src/components/device/connection-status.tsx",
                                lineNumber: 80,
                                columnNumber: 13
...
_s(ConnectionStatus, "mRYtVCadveYDYcubdDnkcGrzKPk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$device$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeviceConnection"],
...
//# sourceMappingURL=src_698def83._.js.map