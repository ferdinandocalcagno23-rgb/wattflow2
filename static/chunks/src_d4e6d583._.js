...
_c2 = Button;
const WorkoutStepsList = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].memo(_s((param)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WorkoutStepsList.useEffect": ()=>{
            // This effect runs when the current step changes.
            if (currentStepRef.current && containerRef.current) {
                var _containerRef_current;
                // Calculate position to center the current step
                const containerHeight = containerRef.current.clientHeight;
                const stepTop = currentStepRef.current.offsetTop;
                const stepHeight = currentStepRef.current.clientHeight;
                const scrollTop = stepTop - containerHeight / 2 + stepHeight / 2;
                (_containerRef_current = containerRef.current) === null || _containerRef_current === void 0 ? void 0 : _containerRef_current.scrollTo({
                    top: scrollTop,
                    behavior: 'auto'
                });
            }
...
function App() {
    ...
    const [leftPanelWidth, setLeftPanelWidth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(30);
                            ...
                            "App.useEffect": (prev)=>{
                                ...
                                if (view === 'SESSION') {
                                    ...
                                    if (currentStep.type === 'ramp' && typeof currentStep.startPower !== 'undefined') {
                                        ...
                                        if (prev.elapsedTimeInStep % 2 === 0 && isErgModeActive) __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$bleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bleService"].setTargetPower(biasedRampPower);
                                    }
                                    return {
                                        ...prev,
    ...
    const handleResizeMouseUp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[handleResizeMouseUp]": ()=>{
            setIsResizing(false);
        }
    }["App.useCallback[handleResizeMouseUp]"], []);
    const handleResizeMouseMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[handleResizeMouseMove]": (e)=>{
            if (!isResizing || !sessionContainerRef.current) return;
            const containerRect = sessionContainerRef.current.getBoundingClientRect();
            const mouseX = e.clientX - containerRect.left;
            const containerWidth = containerRect.width;
            let newWidth = mouseX / containerWidth * 100;
            newWidth = Math.max(20, Math.min(50, newWidth)); // Clamp width
            setLeftPanelWidth(newWidth);
        }
    }["App.useCallback[handleResizeMouseMove]"], [
        isResizing
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
            ...
            window.addEventListener('mouseleave', handleResizeMouseUp);
            return ({
                "App.useEffect": ()=>{
        ...
        const renderLeftControls = ()=>{
            if (mode === 'FREE_RIDE') {
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Button, {
                            onClick: ()=>updateResistance(Math.max(1, resistanceLevel - 1)),
                            variant: "secondary",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Button, {
                            onClick: ()=>updateResistance(Math.min(10, resistanceLevel + 1)),
                            variant: "secondary",
                            className: "rounded-full w-12 h-12 text-xl",
                            children: "+"
                        }, void 0, false, {
    ...
    const renderLiveSessionView = (mode, topPanelContent)=>{
        ...
        const isTargetEditable = isErgModeActive || mode === 'ERG_MODE';
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        mode === 'SESSION' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    style: {
                                        width: isIntervalsCollapsed ? '3rem' : "".concat(leftPanelWidth, "%")
                                    },
                                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-2 cursor-col-resize hidden items-center group", isIntervalsCollapsed ? 'hidden' : 'md:flex'),
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "w-0.5 h-1/4 bg-white/10 rounded-full mx-auto group-hover:bg-neon-cyan transition-colors"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/page.tsx",
                                        lineNumber: 1876,
                                        columnNumber: 29
...
_s1(App, "dqVataVnK/X2eph63KgQkuuTEjw=", false, function() {
    return [
...
__turbopack_context__.k.register(_c3, "WorkoutStepsList");
...
//# sourceMappingURL=src_d4e6d583._.js.map