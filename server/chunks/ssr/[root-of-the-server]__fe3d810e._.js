...
const useWorkoutRecorder = (workoutName, steps)=>{
    ...
    const addDatapoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((power, cadence, heartRate)=>{
...
class StravaService {
    ...
    async uploadActivity(fitBlob, name) {
        ...
        formData.append('file', fitBlob, `${name.replace(/\s+/g, '_')}.fit`);
...
Average Power: ${workout.avgPower} W
--
        ...
        for (const workout of pendingWorkouts){
            if (workout.id) {
                try {
                    ...
                    const fitBlob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$strava$2f$fitEncoder$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFitFile"])(workout);
                    const uploadResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$stravaService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stravaService"].uploadActivity(fitBlob, workout.name);
...
function App() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const intervalData = session.rawData.filter((p)=>p.time >= currentIntervalAbsoluteStartTime);
    ...
    const handleSaveWorkout = ()=>{
        ...
        const fitBlob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$strava$2f$fitEncoder$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createFitFile"])(workoutToSave);
        const url = URL.createObjectURL(fitBlob);
        const a = document.createElement('a');
        a.href = url;
        a.download = `${workout.name.replace(/\s+/g, '_') || 'workout'}.fit`;
    ...
    // --- Components ---
    const LiveGraph = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Card, {
    ...
    const MetricDisplay = ({ label, value, unit, isTarget = false })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const renderFreeRide = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(LiveGraph, {}, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 525,
                    columnNumber: 9
                }, this),
    ...
    const renderErgMode = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex flex-col h-full max-w-7xl mx-auto w-full pt-8 animate-slide-up",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                300
                                    ...
                                    className: `px-8 py-4 rounded-2xl font-bold transition-all border ${targetPower === w ? 'bg-neon-purple text-white border-neon-purple shadow-[0_0_20px_rgba(139,92,246,0.5)] scale-105' : 'bg-white/5 text-gray-400 border-white/5 hover:bg-white/10 hover:border-white/20'}`,
                                    children: [
                                        w,
                                        "w"
                                    ]
    ...
    const renderEditor = ()=>{
        ...
        const getRoundedPath = (x, width, y1, y2)=>{
            ...
            let d = `M ${x},100 `;
            d += `L ${x},${y1 + r} `;
            d += `Q ${x},${y1} ${x + r * ux},${y1 + r * uy} `;
            d += `L ${x + width - r * ux},${y2 - r * uy} `;
            d += `Q ${x + width},${y2} ${x + width},${y2 + r} `;
            d += `L ${x + width},100 Z`;
            return d;
        };
        const renderGraph = ()=>{
                                    ...
                                    'targetPower'
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                value: workout.steps.find((s)=>s.id === selectedStepId)?.[field],
                                                onChange: (e)=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        style: {
                                            left: `${session.totalElapsedTime / workout.totalDuration * 100}%`
                                        },
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fe3d810e._.js.map